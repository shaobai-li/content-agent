"""JSON Schema fragment types — all subclass Schema for tool parameter descriptions & constraints."""
from __future__ import annotations

from collections.abc import Mapping
from typing import Any

from app.agents.tools.base import Schema
