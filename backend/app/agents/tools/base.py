"""Base classes for agent tools — adapted from nanobot."""
...
# Matches Tool._cast_value / Schema.validate_json_schema_value behavior
...
def tool_parameters(schema: dict[str, Any]) -> Callable[[type[_ToolT]], type[_ToolT]]:
    ...
    Use on ``Tool`` subclasses instead of writing ``@property def parameters``.
