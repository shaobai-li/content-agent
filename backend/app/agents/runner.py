...
from app.providers.base import LLMProvider, ToolCallRequest
    ...
    async def run(self, spec: AgentRunSpec) -> AgentRunResult:
        ...
        for iteration in range(spec.max_iterations):
            ...
            if spec.max_iterations_message:
                ...
                final_content = (
                    f"I've completed {spec.max_iterations} rounds of tool use "
                    f"without reaching a final answer. "
                    f"Please try narrowing the request or breaking it into smaller steps."
                )
            self._append_final_message(messages, final_content)
